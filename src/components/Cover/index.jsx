...
import { Wrapper, Logo, Svg, WrapperVar, SvgVar } from './index.styles';
import { motion } from 'framer-motion';

const Cover_SVG = [
  {
    transitionFill: { duration: 2, delay: 0 },
  ...
  {
    transitionFill: { duration: 2, delay: 0.5 },
  ...
  {
    transitionFill: { duration: 2, delay: 1 },
  ...
  {
    transitionFill: { duration: 2, delay: 1.5 },
  ...
  {
    transitionFill: { duration: 2, delay: 2 },
  ...
  {
    transitionFill: { duration: 2, delay: 2.5 },
...
function Cover() {
  return (
    <Wrapper variants={WrapperVar} initial="start" animate="end" exit="exit">
      <Logo layoutId="logo">
        {Cover_SVG.map((item, i) => {
          return (
            <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" key={i}>
              <motion.path
                variants={SvgVar}
                initial="start"
                animate="end"
                transition={{
                  fill: item.transitionFill,
                }}
                fill="white"
                d={item.d}
              />
